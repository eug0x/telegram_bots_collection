...
| :--- | :--- | :--- |
| [music_bot](./bots/music_bot) | **TokenBot** | **Music on Demand.** Downloads and sends any song to a group chat in 10-15 seconds via the `music [name]` command. |
| [secret_msg](./bots/secret_msg) | **TokenBot** | **Hidden DM for Group Chats.** Send secrets that only a specific person can open. Use it in any chat to whisper something privately once they read it, the message vanishes instantly. |
| [gui_messenger](./bots/gui_messenger) | **TokenBot** | **Direct GUI Messenger.** A desktop interface to send private messages and media to specific users through your bot. |
